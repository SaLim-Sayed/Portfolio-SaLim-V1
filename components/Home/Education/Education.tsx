  ...
  const educationData = [
    {
      ...
      details:
        "Degree: Very Good [82%] | Graduation Project: CareMe - healthcare app (Grade: Excellent)",
      stack: [] as string[],
    ...
    },
    {
      ...
      details:
        "Intensive 3-month track focused on full-stack web development using MongoDB, Express.js, React, and Node.js.",
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 text-default-600 text-sm leading-relaxed border-t border-divider pt-4">
                        {edu.stack.map((stack, i) => (
                          <span
                            key={i}
                            className="inline-flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-md text-[13px] font-medium text-slate-700 dark:text-zinc-300 bg-white/95 dark:bg-zinc-900/95 border border-slate-200/95 dark:border-zinc-700/90 shadow-[0_1px_0_0_rgba(15,23,42,0.05)] dark:shadow-none mr-2 mb-2"
                          >
                            {stack}
                          </span>
                        ))}
